...
.aa-mobile-nav{{display:none}} .aa-desktop-nav{{display:grid;grid-template-columns:repeat(7,minmax(100px,1fr));gap:.3rem;margin:.25rem 0 1rem;padding:.35rem;border:1px solid rgba(111,145,175,.34);border-radius:16px;background:rgba(11,25,41,.88);box-shadow:0 12px 34px rgba(0,0,0,.16)}}
...
.aa-chart-wrap{{position:absolute;left:35%;right:1.3rem;bottom:.55rem;height:92px;padding-right:38px}} .aa-chart-wrap>span{{display:block;margin:0 0 -.1rem;color:#71869a;font-size:.57rem;font-weight:900;letter-spacing:.08em}} .aa-return-chart{{display:block;width:100%!important;height:68px!important;overflow:visible}} .aa-chart-baseline{{stroke:rgba(143,167,189,.25);stroke-width:1;stroke-dasharray:4 5;vector-effect:non-scaling-stroke}} .aa-chart-area{{fill:url(#aaReturnFill)}} .aa-chart-line{{fill:none;stroke:#55d5ba;stroke-width:2.25;stroke-linecap:round;stroke-linejoin:round;vector-effect:non-scaling-stroke}} .aa-chart-end{{fill:#dfc06c;stroke:#102235;stroke-width:2;vector-effect:non-scaling-stroke;filter:drop-shadow(0 0 4px rgba(223,192,108,.55))}} .aa-axis-y{{position:absolute;right:0;top:16px;bottom:14px;display:flex;flex-direction:column;align-items:flex-end;justify-content:space-between;color:#71869a;font-size:.52rem}} .aa-axis-y b,.aa-axis-x b{{font-weight:750}} .aa-axis-x{{display:flex;justify-content:space-between;margin:-.2rem 0 0;color:#71869a;font-size:.52rem}} .aa-chart-empty{{position:absolute;left:1.3rem;bottom:1.1rem;color:#75899d;font-size:.72rem}}
...
html body .aa-mobile-nav{{display:grid!important;grid-template-columns:repeat(6,minmax(0,1fr));position:fixed!important;z-index:2147483000!important;left:0!important;right:0!important;bottom:0!important;min-height:68px;padding:.35rem .3rem calc(.35rem + env(safe-area-inset-bottom))!important;background:rgba(3,12,25,.985)!important;border-top:1px solid rgba(56,189,248,.48)!important;box-shadow:0 -12px 34px rgba(0,0,0,.58)!important;pointer-events:auto!important;opacity:1!important;visibility:visible!important}}
html body .st-key-aa_mobile_nav_native{{display:block!important;position:fixed!important;z-index:2147483000!important;left:0!important;right:0!important;bottom:0!important;padding:.35rem .3rem calc(.35rem + env(safe-area-inset-bottom))!important;background:rgba(3,12,25,.985)!important;border-top:1px solid rgba(56,189,248,.48)!important;box-shadow:0 -12px 34px rgba(0,0,0,.58)!important;pointer-events:auto!important}}
html body .st-key-aa_mobile_nav_native [data-testid="stHorizontalBlock"]{{gap:.22rem!important}}
html body .st-key-aa_mobile_nav_native [data-testid="column"]{{min-width:0!important}}
html body .st-key-aa_mobile_nav_native button{{min-height:58px!important;padding:.24rem .08rem!important;border:1px solid rgba(96,165,250,.22)!important;border-radius:12px!important;background:rgba(11,31,52,.72)!important;color:#dcecff!important;font-size:.65rem!important;font-weight:900!important;line-height:1.05!important;white-space:pre-line!important;pointer-events:auto!important;touch-action:manipulation!important}}
html body .st-key-aa_mobile_more_native{{position:fixed!important;z-index:2147482990!important;left:.55rem!important;right:.55rem!important;bottom:calc(76px + env(safe-area-inset-bottom))!important;max-height:68vh!important;overflow-y:auto!important;padding:.8rem!important;border:1px solid rgba(56,189,248,.5)!important;border-radius:20px!important;background:linear-gradient(180deg,#0d2034,#06111f)!important;box-shadow:0 20px 55px rgba(0,0,0,.68)!important;pointer-events:auto!important}}
