...
.aa-return-line{{position:absolute;left:2rem;right:2rem;bottom:1.3rem;height:42px;display:flex;align-items:flex-end;gap:10%}} .aa-return-line:before{{content:"";position:absolute;inset:18px 0 auto;height:3px;background:linear-gradient(100deg,#55d5ba 0 18%,#55d5ba 18% 40%,#dcbf70 40% 43%,#55d5ba 43%);transform:skewY(-7deg);transform-origin:left}} .aa-return-line i{{position:relative;z-index:1;width:9px;height:9px;border-radius:50%;background:#dcc06d}}
...
.aa-aurora{{position:absolute;right:12%;top:-42px;width:310px;height:175px;z-index:1;opacity:.55;filter:drop-shadow(0 0 22px rgba(76,211,190,.16))}} .aa-aurora:before{{content:"";position:absolute;inset:0;background:radial-gradient(ellipse at 60% 45%,rgba(67,203,177,.24),transparent 62%)}} .aa-aurora i{{position:absolute;top:0;bottom:0;width:1px;background:linear-gradient(#d8bd6b,#62d1c3,transparent);transform:rotate(34deg)}} .aa-aurora i:nth-child(1){{left:18%}}.aa-aurora i:nth-child(2){{left:36%;transform:rotate(-28deg)}}.aa-aurora i:nth-child(3){{left:53%;transform:rotate(23deg)}}.aa-aurora i:nth-child(4){{left:69%;transform:rotate(-34deg)}}.aa-aurora i:nth-child(5){{left:84%;transform:rotate(31deg)}}
