...
.aa-portfolio-command{{position:relative;display:grid;grid-template-columns:minmax(0,1.75fr) minmax(230px,.72fr);gap:1rem;align-items:start;margin:.2rem 0 .55rem}} .aa-portfolio-command>article{{position:relative;border:1px solid rgba(111,145,175,.46);border-radius:20px;background:linear-gradient(145deg,rgba(16,33,51,.96),rgba(11,25,41,.96));padding:1.55rem;overflow:hidden}} .aa-portfolio-value{{min-height:236px}}
...
.aa-confidence{{display:flex;min-height:154px;flex-direction:column;align-items:center;justify-content:center;text-align:center}} .aa-confidence>strong{{font-size:3rem;line-height:1;color:#f4f7fb;margin:.65rem 0 .25rem}} .aa-confidence>small{{color:#e0c171;font-size:.72rem;font-weight:900;letter-spacing:.04em}}
