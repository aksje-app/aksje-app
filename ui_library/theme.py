...
.aa-overview-hero h1{{margin:.45rem 0 .15rem;font-size:clamp(1.9rem,3vw,3.15rem);line-height:1.06;color:#f7fbff}} .aa-overview-hero p{{margin:.35rem 0 1rem;color:#a9bac9;font-size:1rem}}
...
.aa-portfolio-command{{position:relative;display:grid;grid-template-columns:minmax(0,1.75fr) minmax(230px,.72fr);gap:1rem;margin:.2rem 0 1rem}} .aa-portfolio-command>article{{position:relative;min-height:236px;border:1px solid rgba(111,145,175,.46);border-radius:20px;background:linear-gradient(145deg,rgba(16,33,51,.96),rgba(11,25,41,.96));padding:1.55rem;overflow:hidden}}
...
.aa-chart-wrap{{position:absolute;left:36%;right:1.6rem;bottom:.8rem;height:104px}} .aa-chart-wrap>span{{display:block;margin:0 0 .1rem;color:#71869a;font-size:.62rem;font-weight:900;letter-spacing:.08em}} .aa-return-chart{{display:block;width:100%!important;height:86px!important;overflow:visible}} .aa-chart-baseline{{stroke:rgba(143,167,189,.2);stroke-width:1;stroke-dasharray:4 5;vector-effect:non-scaling-stroke}} .aa-chart-area{{fill:url(#aaReturnFill)}} .aa-chart-line{{fill:none;stroke:#55d5ba;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round;vector-effect:non-scaling-stroke}} .aa-chart-end{{fill:#dfc06c;stroke:#102235;stroke-width:2;vector-effect:non-scaling-stroke;filter:drop-shadow(0 0 4px rgba(223,192,108,.55))}} .aa-chart-empty{{position:absolute;left:1.55rem;bottom:1.35rem;color:#75899d;font-size:.78rem}}
