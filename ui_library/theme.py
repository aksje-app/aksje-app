...
.aa-return-chart{{position:absolute;left:1.5rem;right:1.5rem;bottom:1rem;width:calc(100% - 3rem);height:76px;overflow:visible}} .aa-return-chart polyline{{fill:none;stroke:#55d5ba;stroke-width:3;stroke-linecap:round;stroke-linejoin:round;vector-effect:non-scaling-stroke}} .aa-return-chart circle{{fill:#dfc06c;stroke:#102235;stroke-width:2;vector-effect:non-scaling-stroke}} .aa-chart-empty{{position:absolute;left:1.55rem;bottom:1.35rem;color:#75899d;font-size:.78rem}}
