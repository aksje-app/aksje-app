...
.aa-portfolio-command{{position:relative;display:grid;grid-template-columns:minmax(0,1.75fr) minmax(230px,.72fr);gap:1rem;margin:.2rem 0 1rem;isolation:isolate}} .aa-portfolio-command>article{{position:relative;z-index:2;min-height:210px;border:1px solid rgba(111,145,175,.46);border-radius:20px;background:rgba(14,29,46,.9);padding:1.35rem;overflow:hidden}}
.aa-portfolio-value>span,.aa-confidence>span{{display:block;color:#9aaabd;font-size:.78rem;font-weight:900;letter-spacing:.06em}} .aa-portfolio-value>strong{{display:block;margin:1.65rem 0 0;color:#f4f7fb;font-size:clamp(2rem,4.2vw,4rem);line-height:1}} .aa-portfolio-value>b{{display:block;margin:.4rem 0;color:#58d3b5;font-size:1.45rem}} .aa-portfolio-value>b small{{color:#8799ab;font-weight:650;font-size:.9rem}}
.aa-return-line{{position:absolute;left:2rem;right:2rem;bottom:1.3rem;height:42px;display:flex;align-items:flex-end;justify-content:space-between}} .aa-return-line:before{{content:"";position:absolute;left:0;right:0;bottom:16px;height:3px;border-radius:3px;background:linear-gradient(90deg,#55d5ba 0 20%,#2c8e83 20% 22%,#55d5ba 22% 46%,#dcbf70 46% 48%,#55d5ba 48% 75%,#2c8e83 75% 77%,#55d5ba 77%);clip-path:polygon(0 68%,15% 54%,28% 70%,43% 34%,56% 48%,70% 14%,84% 34%,100% 0,100% 24%,84% 58%,70% 38%,56% 72%,43% 58%,28% 94%,15% 78%,0 92%)}} .aa-return-line i{{position:relative;z-index:1;width:8px;height:8px;margin-bottom:13px;border-radius:50%;background:#dcc06d}}
.aa-confidence{{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center}} .aa-confidence>strong{{font-size:4.1rem;line-height:1;color:#f4f7fb;margin:.7rem 0 .25rem}} .aa-confidence>small{{color:#e0c171;font-weight:900;letter-spacing:.04em}}
.aa-aurora{{position:absolute;right:4%;top:-120px;width:360px;height:145px;z-index:1;opacity:.48;overflow:hidden;filter:drop-shadow(0 0 22px rgba(76,211,190,.16))}} .aa-aurora:before{{content:"";position:absolute;inset:0;background:radial-gradient(ellipse at 60% 45%,rgba(67,203,177,.24),transparent 62%)}} .aa-aurora i{{position:absolute;top:-20px;bottom:0;width:1px;background:linear-gradient(#d8bd6b,#62d1c3,transparent);transform:rotate(34deg)}} .aa-aurora i:nth-child(1){{left:18%}}.aa-aurora i:nth-child(2){{left:36%;transform:rotate(-28deg)}}.aa-aurora i:nth-child(3){{left:53%;transform:rotate(23deg)}}.aa-aurora i:nth-child(4){{left:69%;transform:rotate(-34deg)}}.aa-aurora i:nth-child(5){{left:84%;transform:rotate(31deg)}}
.aa-portfolio-facts{{display:grid;grid-template-columns:repeat(3,1fr);margin:.2rem 0 1.2rem}} .aa-portfolio-facts>div{{padding:.55rem 1rem;border-right:1px solid rgba(111,145,175,.3)}} .aa-portfolio-facts>div:last-child{{border:0}} .aa-portfolio-facts strong,.aa-portfolio-facts span{{display:block}} .aa-portfolio-facts strong{{font-size:1.65rem;color:#eff5fb}} .aa-portfolio-facts span{{font-size:.72rem;color:#7f92a5;font-weight:900}}
