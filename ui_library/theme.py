...
.aa-portfolio-value>span,.aa-confidence>span{{display:block;color:#9aaabd;font-size:.7rem;font-weight:900;letter-spacing:.06em}} .aa-portfolio-value>strong{{display:block;margin:1.45rem 0 0;color:#f4f7fb;font-size:clamp(1.8rem,3vw,3rem);line-height:1}} .aa-portfolio-value>b{{display:block;margin:.38rem 0;color:#58d3b5;font-size:1.12rem}} .aa-portfolio-value>b small{{color:#8799ab;font-weight:650;font-size:.78rem}}
...
.aa-confidence{{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center}} .aa-confidence>strong{{font-size:3rem;line-height:1;color:#f4f7fb;margin:.45rem 0 .2rem}} .aa-confidence>small{{color:#e0c171;font-size:.72rem;font-weight:900;letter-spacing:.04em}} .aa-confidence-components{{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.35rem;width:100%;margin-top:1rem;padding-top:.8rem;border-top:1px solid rgba(143,167,189,.18)}} .aa-confidence-components>div{{padding:.3rem;border-radius:8px;background:rgba(6,17,31,.42)}} .aa-confidence-components span,.aa-confidence-components strong{{display:block}} .aa-confidence-components span{{color:#7f92a5;font-size:.58rem;font-weight:800;text-transform:uppercase}} .aa-confidence-components strong{{color:#dce7f1;font-size:.9rem}} .aa-confidence-empty{{margin:.25rem 0;color:#7f92a5;font-size:.68rem;line-height:1.35}}
