    ...
    def evaluate(self, candidate: CandidateSnapshot, context: StrategyEvaluationContext) -> StrategyDecision:
        ...
        return StrategyDecision(
            ...
            metadata={
                ...
                "quality_blocker_codes": result.get("quality_blocker_codes"),
                "quality_diagnostics": result.get("quality_diagnostics"),
                "quality_evidence_sufficient": result.get("quality_evidence_sufficient"),
                "quality_missing_components": result.get("quality_missing_components"),
                "quality_invalid_components": result.get("quality_invalid_components"),
