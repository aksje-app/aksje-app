#!/usr/bin/env python3
"""Static release audit for v19.15.0.
...
def audit(root: Path = ROOT) -> dict:
    ...
    _check(f'APP_VERSION = "{EXPECTED_VERSION}"' in version_source, "VERSION", "APP_VERSION er ikke v19.15.0", errors)
    ...
    for name in ("RELEASE_NOTES_v19.15.0.md", "ACCEPTANCE_v19.15.0.md", "DEPLOY_v19.15.0.md"):
