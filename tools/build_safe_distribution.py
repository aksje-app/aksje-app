#!/usr/bin/env python3
"""Build clean, validated v19.13.1 release archives."""
...
UPDATE_FILES = {
    ...
    "RELEASE_NOTES_v19.13.1.md", "DEPLOY_v19.13.1.md",
    "DISTRIBUTION_SECURITY_POLICY_v19.13.1.md", "MIGRATION_v19.13.1.md",
    "TEST_REPORT_v19.13.1.md", "ACCEPTANCE_v19.13.1.md",
...
MIGRATION_FILES = {
    "app_version.py", "MIGRATION_v19.13.1.md", "DEPLOY_v19.13.1.md", "DISTRIBUTION_SECURITY_POLICY_v19.13.1.md",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bygg trygge v19.13.1-distribusjonspakker.")
