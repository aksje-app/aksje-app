#!/usr/bin/env python3
"""Build clean, validated v19.13.2 release archives."""
...
UPDATE_FILES = {
    ...
    "DISTRIBUTION_SECURITY_POLICY_v19.13.2.md", "MIGRATION_v19.13.2.md",
    "TEST_REPORT_v19.13.2.md", "ACCEPTANCE_v19.13.2.md",
    ...
    "investment_pipeline.py", "norwegian_report_language.py",
    ...
    "tests/test_v19132_report_semantics_mobile.py",
...
MIGRATION_FILES = {
    "app_version.py", "MIGRATION_v19.13.2.md", "DEPLOY_v19.13.2.md", "DISTRIBUTION_SECURITY_POLICY_v19.13.2.md",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bygg trygge v19.13.2-distribusjonspakker.")
