#!/usr/bin/env python3
"""Build clean, validated v19.3.0 release archives."""
...
MIGRATION_FILES = {
    "MIGRATION_v19.3.0.md", "DEPLOY_v19.3.0.md", "DISTRIBUTION_SECURITY_POLICY_v19.3.0.md",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bygg trygge v19.3.0-distribusjonspakker.")
