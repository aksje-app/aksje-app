...
PROFILE_REQUIRED_FILES = {
    "full": {
        ...
        "services/autonomy_activation_service.py", "services/autonomy_learning_account_service.py", "services/evaluation_export_service.py", "services/autonomy_technical_contribution_service.py", "strategies/technical_benchmark.py", "strategies/autonomy_strategy.py", "signal_engine.py", "scanner_worker.py",
        ...
        "autonomy_overview.py", "RELEASE_NOTES_v19.9.0.md", "DEPLOY_v19.9.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.9.0.md", "MIGRATION_v19.9.0.md", "ACCEPTANCE_v19.9.0.md",
    ...
    "migration": {
        ...
        "MIGRATION_v19.9.0.md", "DEPLOY_v19.9.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.9.0.md", "tools/prepare_safe_upgrade.py",
