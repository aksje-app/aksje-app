...
PROFILE_REQUIRED_FILES = {
    "full": {
        ...
        "services/autonomy_activation_service.py", "services/autonomy_learning_account_service.py", "services/evaluation_export_service.py", "strategies/technical_benchmark.py", "strategies/autonomy_strategy.py", "signal_engine.py", "scanner_worker.py",
        ...
        "autonomy_overview.py", "RELEASE_NOTES_v19.8.0.md", "DEPLOY_v19.8.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.8.0.md", "MIGRATION_v19.8.0.md", "ACCEPTANCE_v19.8.0.md",
    ...
    "migration": {
        ...
        "domain/persistence.py", "domain/strategy_versioning.py", "domain/market_snapshot.py", "domain/strategy_account.py",
        "services/strategy_account_service.py", "services/simulated_execution_service.py",
        "services/autonomy_activation_service.py", "services/autonomy_learning_account_service.py", "services/evaluation_export_service.py",
        "tools/export_persistent_storage_v1920.py",
        "tools/import_persistent_storage_v1920.py", "tools/migrate_strategy_accounts_v1980.py", "tools/export_strategy_evaluation_v1980.py",
        "MIGRATION_v19.8.0.md", "DEPLOY_v19.8.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.8.0.md", "tools/prepare_safe_upgrade.py",
