...
PROFILE_REQUIRED_FILES = {
    "full": {
        ...
        "autonomy_overview.py", "RELEASE_NOTES_v19.13.1.md", "DEPLOY_v19.13.1.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.13.1.md", "MIGRATION_v19.13.1.md", "ACCEPTANCE_v19.13.1.md",
    ...
    "migration": {
        ...
        "tools/migrate_strategy_promotion_v19120.py", "tools/export_strategy_evaluation_v19120.py",
        "services/paper_migration_service.py", "tools/migrate_paper_foundation_v19130.py",
        "MIGRATION_v19.13.1.md", "DEPLOY_v19.13.1.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.13.1.md", "tools/prepare_safe_upgrade.py",
