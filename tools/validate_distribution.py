...
PROFILE_REQUIRED_FILES = {
    "full": {
        ...
        "pages/strategy_versions.py", "ui/candidate_cards.py", "ui/live_market_banner.py",
        "ui/legacy_context.py", "ui/global_styles.py", "app_core/context.py",
        "domain/strategy_versioning.py", "domain/market_snapshot.py", "domain/strategy_contract.py", "services/strategy_registry_service.py", "services/strategy_binding.py",
        "services/market_snapshot_service.py", "services/technical_signal_service.py", "services/parallel_strategy_service.py", "strategies/technical_benchmark.py", "strategies/autonomy_strategy.py", "signal_engine.py", "scanner_worker.py",
        ...
        "autonomy_overview.py", "RELEASE_NOTES_v19.7.0.md", "DEPLOY_v19.7.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.7.0.md", "MIGRATION_v19.7.0.md", "ACCEPTANCE_v19.7.0.md",
    ...
    "update": {
        ...
        "app_core/context.py", "domain/strategy_versioning.py", "domain/market_snapshot.py", "domain/strategy_contract.py", "repositories/application.py",
        "services/service_registry.py", "services/strategy_registry_service.py", "services/strategy_binding.py",
        "services/market_snapshot_service.py", "services/technical_signal_service.py", "services/parallel_strategy_service.py", "strategies/technical_benchmark.py", "strategies/autonomy_strategy.py", "signal_engine.py", "scanner_worker.py",
        "pages/autonomy.py", "pages/strategy_versions.py", "ui/global_styles.py", "trading_engine.py",
    ...
    "migration": {
        ...
        "services/persistence_service.py", "services/strategy_registry_service.py", "services/strategy_binding.py",
        "storage_architecture.py", "utils.py", "repositories/base.py", "repositories/application.py",
        "domain/persistence.py", "domain/strategy_versioning.py", "domain/market_snapshot.py", "tools/export_persistent_storage_v1920.py",
        "tools/import_persistent_storage_v1920.py", "MIGRATION_v19.7.0.md", "DEPLOY_v19.7.0.md",
        "DISTRIBUTION_SECURITY_POLICY_v19.7.0.md", "tools/prepare_safe_upgrade.py",
