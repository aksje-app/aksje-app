# Deploy v19.15.0 til isolert Render-testmiljø

## Kilde

Deploy kun den godkjente Git-committen for v19.15.0. Program, ZIP, manifest og Render skal vise samme commit-ID.
