...
def render_paper_trading_dashboard():
    ...
    with status_cols[0]:
        refresh_prices = st.button("Oppdater kurser", key="paper_refresh_prices_v1871", type="primary", use_container_width=False)
    with status_cols[1]:
    ...
    if active_paper_tab_slug == "handel":
        ...
        with fund_tab:
            ...
            with fund_sell_col:
                ...
                if st.button("🔴 PAPER-SELG FOND/ETF", key="paper_fund_sell_v1871", use_container_width=True, disabled=(sell_symbol == "Ingen")):
    ...
    if active_paper_tab_slug == "portefolje":
        ...
        with st.expander("Juster startverdier / porteføljeverdi", expanded=False):
            ...
            with c_apply:
                if st.button("Bruk porteføljeverdi", key="paper_apply_total_value_v1871", use_container_width=False):
                    ...
                    if new_cash < 0:
                        ...
                        st.rerun()
            with c_reset:
                if st.button("Reset til startkapital", key="restore_reset_paper_portfolio_v1871", use_container_width=False):
