...
def _render_tl_progress_step(holder: Any, progress: Any, *, title: str, step: int, total: int, text: str) -> None:
    ...
    holder.markdown(
        ...
        '<span style="width:21px;height:21px;border:4px solid rgba(125,211,252,.25);border-top-color:#38bdf8;border-radius:999px;display:inline-block;animation:tlSpin .72s linear infinite;flex:0 0 auto;"></span>'
