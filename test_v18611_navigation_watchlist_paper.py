...
def test_v18613_navigation_watchlist_paper_static_guards():
    for name in [
        "app.py",
        "workspace_layout.py",
        "alert_center.py",
    ...
    assert "_close_control_center_panel_v18613" in workspace
    assert "banner_detail_suppress_picker_once_v18613" in app
    ...
    assert "PAPER_FUND_LOOKUP_CATALOG_v18613" in app
