...
def test_release_identity_is_safe_distribution_patch():
    assert APP_VERSION == "v19.0.22"
    assert PREVIOUS_APP_VERSION == "v19.0.21"


def test_validator_rejects_runtime_secret_and_generated_report():
    entries = [
        FileEntry("app.py", 1, b"x"),
        FileEntry("app_version.py", 30, b'APP_VERSION = "v19.0.22"'),
        ...
        FileEntry("RELEASE_NOTES_v19.0.22.md", 0, b""),
        FileEntry("DEPLOY_v19.0.22.md", 0, b""),
