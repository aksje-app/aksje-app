...
def test_release_identity_is_safe_distribution_patch():
    ...
    assert PREVIOUS_APP_VERSION == "v19.2.0"


def test_validator_rejects_runtime_secret_and_generated_report():
    entries = [
        FileEntry("app.py", 1, b"x"),
        FileEntry("app_version.py", 30, b'APP_VERSION = "v19.3.0"'),
        ...
        FileEntry("RELEASE_NOTES_v19.3.0.md", 0, b""),
        FileEntry("DEPLOY_v19.3.0.md", 0, b""),
