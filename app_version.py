...
CHANGELOG = [
    ...
    "v18.6.69: Interaktiv Analyse Layout Rebuild: refresh-state for Interaktiv analyse, færre store bokser/statusfelt og grafmodus Standard/Teknisk/Avansert. Ingen motorlogikk endret.",
