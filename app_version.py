APP_VERSION = "v18.6.49"
APP_VERSION_NAME = "UI cleanup and runtime data hygiene"
APP_BUILD_LABEL = APP_VERSION

CHANGELOG = [
    "v18.6.49: Admin/Drift fjernet helt fra venstremeny etter TRACE; Admin/Drift styres kun fra toppmenyen; sidebar trace fjernet. Tidligere v18.6.48: Midlertidig sidebar trace/debug viser nøyaktig hvilke sidebar/admin/drift-komponenter som renderer Admin/Drift i venstremenyen.",
